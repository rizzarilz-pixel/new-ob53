...
# Storage folders - Updated for Vercel Support
if os.environ.get('VERCEL'):
    # Vercel hanya mengizinkan penulisan di folder /tmp
    BASE_FOLDER = "/tmp/BLACK-APIS-ERA"
else:
    CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
    BASE_FOLDER = os.path.join(CURRENT_DIR, "BLACK-APIS-ERA")

# Folder turunan tetap menggunakan BASE_FOLDER yang sudah disesuaikan
...
# Pastikan folder dibuat di lokasi yang benar
...
ACCOUNT_RARITY_PATTERNS = {
    "REPEATED_DIGITS_4": [r"(\d)\1{2,}", 2]
    "REPEATED_DIGITS_3": [r"(\d)\1{2}", 2]
    "SEQUENTIAL_5": [r"(\d)\1{2}", 4]
    "SEQUENTIAL_4": [r"(\d)\1{2}", 3]
    "PALINDROME_6": [r"(\d)\1{2}", 5]
    "PALINDROME_4": [r"(\d)\1{2}", 3]
    "SPECIAL_COMBINATIONS_HIGH": [r"(\d)\1{2}", 4]
    "SPECIAL_COMBINATIONS_MED": [r"(\d)\1{2}", 2]
    "QUADRUPLE_DIGITS": [r"(\d)\1{3,}", 5],
    "MIRROR_PATTERN_HIGH": [r"(\d)\1{2}", 3]
    "MIRROR_PATTERN_MED": [r"(\d)\1{2}", 2]
